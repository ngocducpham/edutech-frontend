...
class StudentForm extends BasicForm {
	constructor(props) {
		super(props);
		this.state = {
	...
	getInitialFormValues = () => {
		const { isEditing, dataDetail, provinceAutocomplete } = this.props;
		if (!isEditing) {
			return {
	...
	render() {
		...
		console.log(provinceComboboxData)
		return (
		<Form
			id={formId}
			ref={this.formRef}
		...
		>
			...
			<Row gutter={16}>
                ...
                <TextField
                        ...
                        label={t("form.label.admissionYear")}
                        type="number"
                        minLength={4}
                        maxLength={4}
                        required
