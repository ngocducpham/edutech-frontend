...
class MutipleAnswer extends Component {
    constructor(props) {
        super(props);
        this.state = { 
            ...
            { 
              ...
              render: (rightAnswer, record, i) => {
                return (
                    ...
                    <Checkbox onChange={(e)=>{this.handleChangeCheckbox(e , i)}}
                        />
                    </Form.Item>
                )
              }
    ...
    handleChangeCheckbox = (e, i) => {
        ...
        if(newAnswerList[i].rightAnswer === false){
            newAnswerList[i].rightAnswer = true;
        }else{
            newAnswerList[i].rightAnswer = false;
        }
