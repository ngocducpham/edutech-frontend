...
class PasswordGeneratorField extends BaseField {
            ...
            >
                {
                    ...
                    <Input onChange={onChange} style={style} size={size} placeholder={this.getPlaceHolder()} disabled={disabled} type={type} onBlur={onBlur} value={value}/>
                        {suffix}
                    </div>
                } 
            </Form.Item>
...
export default withTranslation(['textField', 'baseField'])(PasswordGeneratorField);