...
class CustomAutoCompleteField extends BaseField {
    ...
    render() {
        ...
        return (<>
            ...
            <div>
            {
                showEmptyMsg ?? options.length === 0 ? 
                        <div style={{minHeight: 24,color: '#ff4d4f', marginTop: '-24px', marginBottom:24}}>
                            {emptyMessage}
                        </div> 
                    : 
                null
...
export default withTranslation(['constants', 'baseField'])(CustomAutoCompleteField);